...
total_time=0
num_accepted=0  # Variable to keep track of the number of accepted test cases
...
do  
    ...
    if [ -z "$diff_output" ]; then
        echo "Accepted."
        num_accepted=$((num_accepted+1))  # Increment the number of accepted test cases
    else
        echo "Rejected."
    fi
    echo "------------------------"
...
echo "$num_accepted/$num_tests test cases accepted."